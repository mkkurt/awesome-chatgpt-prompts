...
> I will write a random sentence and you will output 0 or 1 if the sentence i provide describes whether or not (e.g: the guy picked up the stick), respectively. If the provided sentence is irrelevant, output -1. You are not going to describe anything, just going to say 0,1 or -1. Okay? First one: (e.g: He changed his mind and walked away from the stick.)
